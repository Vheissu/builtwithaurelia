...
define('partials/project',["require", "exports", 'aurelia-framework', 'aurelia-event-aggregator'], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1) {
    "use strict";
    var Project = (function () {
        function Project(ea) {
            this.ea = ea;
        }
        Project.prototype.handleClick = function (url, name) {
            if (window.clicky) {
        ...
        Project = __decorate([
            aurelia_framework_1.autoinject,
            aurelia_framework_1.customElement('project'), 
