...
define('app',["require", "exports", 'aurelia-framework', './services/application'], function (require, exports, aurelia_framework_1, application_1) {
    "use strict";
    var App = (function () {
        ...
        App = __decorate([
            aurelia_framework_1.autoinject, 
            __metadata('design:paramtypes', [application_1.ApplicationService])
        ], App);
        return App;
    }());
    exports.App = App;
...
define('home',["require", "exports", 'aurelia-framework', 'aurelia-router', './api'], function (require, exports, aurelia_framework_1, aurelia_router_1, api_1) {
    ...
    var Home = (function () {
        ...
        Home.prototype.getRandomBackgroundColour = function (name) {
            ...
            var index = hash % this.bgClasses.length;
