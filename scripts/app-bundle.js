    ...
    var Api = (function () {
        ...
        Api.prototype.getProjects = function (maxPerPage, page) {
            return this.http.fetch('https://raw.githubusercontent.com/Vheissu/builtwithaurelia-projects/master/projects.json')
                ...
                var offset = (page * maxPerPage) - maxPerPage;
                console.log(offset);
...
define('text!pagination.html', ['module'], function(module) { module.exports = "<template bindable=\"totalPages\">\n    <a route-href=\"route: home; params.bind: {page: i}\" repeat.for=\"i of totalPages\">${i}</a>\n</template>\n"; });
