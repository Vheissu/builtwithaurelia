...
define('api',["require", "exports", 'aurelia-framework', 'aurelia-fetch-client', './services/application', './common/utils'], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1, application_1, utils_1) {
    "use strict";
    var Api = (function () {
        ...
        Api.prototype.addProject = function (project) {
            ...
            firebase.database().ref("submissions/" + utils_1.slugify(project.name)).update(project);
        };
        Api = __decorate([
...
define('home',["require", "exports", 'aurelia-framework', 'aurelia-event-aggregator', 'aurelia-router', './api', './services/user', './common', './common/utils'], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, aurelia_router_1, api_1, user_1, common_1, utils_1) {
    "use strict";
    var Home = (function () {
        ...
        Home.prototype.vote = function (evt, name) {
            if (this.userService.isLoggedIn) {
                ...
                this.projects.map(function (project) {
                    if (utils_1.slugify(project.name) === utils_1.slugify(name)) {
