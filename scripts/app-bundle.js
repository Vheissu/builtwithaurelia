...
define('home',["require", "exports", 'aurelia-framework', 'aurelia-router', './api'], function (require, exports, aurelia_framework_1, aurelia_router_1, api_1) {
    ...
    var Home = (function () {
        ...
        Object.defineProperty(Home.prototype, "background", {
            get: function () {
        ...
        Home.prototype.getRandomBackgroundColour = function () {
            var _this = this;
            var getBackgroundString = function () {
                return _this.bgClasses[Math.floor(Math.random() * _this.bgClasses.length)];
            };
            var random = getBackgroundString();
            if (random !== this.lastBackground) {
                this.lastBackground = random;
                return random;
            }
            else {
                var random_1 = getBackgroundString();
                this.lastBackground = random_1;
                return random_1;
            }
        };
        ...
        __decorate([
            aurelia_framework_1.computedFrom('bgClasses'), 
            __metadata('design:type', Object)
        ], Home.prototype, "background", null);
        Home = __decorate([
            aurelia_framework_1.autoinject, 
