        ...
        Home.prototype.canActivate = function (params) {
            ...
            this.api.getProjects(maxProjectsPerPage, this.currentPage).then(function (projects) {
                if (projects.length) {
                    ...
                    _this.totalNumberOfPages = Math.ceil(_this.projects.length / maxProjectsPerPage);
                }
                else {
